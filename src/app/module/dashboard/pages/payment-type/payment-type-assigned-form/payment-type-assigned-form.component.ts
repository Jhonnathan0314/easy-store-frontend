...
@Component({
  selector: 'app-payment-type-assigned-form',
  standalone: true,
  ...
  templateUrl: './payment-type-assigned-form.component.html',
  styleUrls: ['../../../../../../../public/assets/css/layout.css'],
  providers: [MessageService]
})
export class PaymentTypeAssignedFormComponent {
  ...
  buttonLabel: string = 'Vincular';
  title: string = 'Vincular tipo de pago a tienda';
